...
options(cores = if (Sys.info()['sysname'] == 'Windows') 1L else 2L)
options(mc.cores = if (Sys.info()['sysname'] == 'Windows') 1L else 2L)
```
...
doParallel::registerDoParallel(cores = getOption('cores'))
theme_set(theme_bw())
```
